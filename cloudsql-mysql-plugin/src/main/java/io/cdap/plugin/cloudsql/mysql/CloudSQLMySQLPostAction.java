...
public class CloudSQLMySQLPostAction extends AbstractQueryAction {
    ...
    public CloudSQLMySQLPostAction(CloudSQLMySQLQueryActionConfig cloudsqlMysqlQueryActionConfig) {
        super(cloudsqlMysqlQueryActionConfig, false);
        this.cloudsqlMysqlQueryActionConfig = cloudsqlMysqlQueryActionConfig;
    }
    ...
    public void configurePipeline(PipelineConfigurer pipelineConfigurer) {
        ...
        CloudSQLMySQLUtil.checkConnectionName(
                failureCollector,
                cloudsqlMysqlQueryActionConfig.instanceType,
                cloudsqlMysqlQueryActionConfig.connectionName);

        super.configurePipeline(pipelineConfigurer);
    }

    /** Mysql Action Config. */
    public static class CloudSQLMySQLQueryActionConfig extends QueryActionConfig {

        @Name(CloudSQLMySQLConstants.CONNECTION_NAME)
        @Description(
                "The CloudSQL instance to connect to. For a public instance, the connection string should be "
                        + "in the format <PROJECT_ID>:<REGION>:<INSTANCE_NAME> which can be found in the instance "
                        + "overview page. For a private instance, enter the internal IP address of the "
                        + "Compute Engine VM cloudsql proxy is running on.")
        ...
        public CloudSQLMySQLQueryActionConfig() {
